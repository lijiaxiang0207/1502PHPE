...
$(function() {
	...
	$("#stepTip a").bind("click", function() {
		...
		expires: 1
	}, null == $.cookie("viewTimes") ? ($("#stepTip img").attr("src", ctx + "/images/tiponce.jpg").parent("#stepTip").fadeIn(200), $.cookie("viewTimes", "1", b)) : (c = parseInt($.cookie("viewTimes")) + 1, $("#stepTip img").attr("src", ctx + "/images/tipagain.jpg").parent("#stepTip").fadeIn(200), $.cookie("viewTimes", c, b)), $(document).click(function() {
		var a = [];
		...
		submitHandler: function(b) {
			...
			a = !0, c = $("#companyId").val(), d = $("#companyName").val(), e = $("#name").val(), f = $("#logoShow img").attr("src"), g = $("#website").val(), "http://" != g.substring(0, 7) && (g = "http://" + g), h = $("#city").val(), i = $("#select_industry_hidden").val(), j = $("#select_scale_hidden").val(), k = $("#s_radio_hidden").val(), l = "", l += "[", $("#stagesList > li").each(function(a) {
				...
				dataType: "json",
				url: "?r=company/setone"
			}).done(function(a) {
				a.success == true ? window.location.href = "?r=company/settwo" : alert(a.msg);
				//$("#beError").text(a.msg).show(), $(b).find(":submit").attr("disabled", !1)
				// a.success ? window.location.href = "?r=company/settwo" : $("#beError").text(a.msg).show(), $(b).find(":submit").attr("disabled", !1)
			})
		}
