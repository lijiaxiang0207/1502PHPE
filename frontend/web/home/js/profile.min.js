			...
			$(this).validate({
				...
				submitHandler: function(a) {
					...
					$(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
						url: "?r=resume/projectexperience",
						type: "POST",
						data: {
							projectName: b,
							positionName: c,
		...
		$(this).validate({
			...
			submitHandler: function(a) {
				var b = $('input[name="schoolName"]', a).val(),
					...
					j = $("#resubmitToken").val();
				$(a).find(":submit").val("保存中...").attr("disabled", !0), $.ajax({
					url: "?r=resume/educationbackground",
					type: "POST",
					data: {
						schoolName: b,
						education: c,
