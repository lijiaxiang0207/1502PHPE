...
<div id="body">
    ...
    <div id="container">
        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <img width="668" height="56" class="c_steps" alt="第三步" src="home/images/step3.png">
                    ...
                    <form method="post" action="http://www.lagou.com/cl/saveLeaderInfos.json" id="memberForm">
                        ...
                        <a class="btn_cancel fr" href="?r=company/setfour">跳过</a>
                    </form>
                </dd>
            </dl>
        </div>
        ...
        <script src="home/js/step3.min.js" type="text/javascript"></script>
        <div class="clear"></div>
