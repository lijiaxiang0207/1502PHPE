        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <img width="668" height="56" class="c_steps" alt="第四步" src="home/images/step4.png">
                    ...
                    <form method="post" action="http://www.lagou.com/cp/saveCompanyProducts.json" id="productForm">
                        ...
                        <a class="btn_cancel fr" href="?r=company/setfive">跳过</a>
                    </form>
                </dd>
            </dl>
        </div>

        <script src="home/js/step4.min.js" type="text/javascript"></script>
        <div class="clear"></div>
