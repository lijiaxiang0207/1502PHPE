...
<head>
    ...
    <script src="home/js/step1.min.js" type="text/javascript"></script>
...
<div id="body">
    ...
    <div id="container">
        ...
        <div style="" id="stepTip">
            <a></a>
            <img width="803" height="59" src="home/images/tiponce.jpg">
        </div>
            ...
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    <form id="stepForm">
                        ...
                        <img width="668" height="56" class="c_steps" alt="第一步" src="./home/images/step1.png">

                        <h3>公司全称</h3>
                        <input type="text" placeholder="请输入公司全称，如:八维教育研修学院" value="" name="companyallname"
                               id="companyName" class="valid">


                        <h3>公司简称</h3> <!--非必填-->
                        <input type="text" placeholder="请输入公司简称，如:八维" value="" name="name" id="name" class="valid">
                        ...
                        <h3>公司网址</h3>
                        <input type="text" placeholder="请输入公司网址，如：www.dpflove.com" value="" name="website" id="website">

                        <h3>所在城市</h3>
                        <input type="text" placeholder="请输入工作城市，如：北京" name="checkcity" id="city">
                        ...
                        <!-- <h3>投资机构</h3>
                            <ul id="stagesList" class="reset">
                                <li>
                                    ...
                                    <input type="text" placeholder="请输入投资机构，如真格基金" name="stageorg">
                                </li>
                            </ul>
