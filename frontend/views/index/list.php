    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul class="reset" id="navheader">
                ...
                <li><a href="?r=index/jianli" rel="nofollow">我的简历</a></li>
    ...
    <div id="container">
        ...
        <div class="sidebar">
            ...
            <a href="http://www.w3cplus.com/" target="_blank" class="partnersAd">
                <img src="./home/images/w3cplus.png" width="230" height="80" alt="w3cplus"/>
            </a>
            <a href="" target="_blank" class="partnersAd">
                <img src="./home/images/jquery_school.jpg" width="230" height="80" alt="JQ学校"/>
            </a>
            <a href="http://linux.cn/" target="_blank" class="partnersAd">
                <img src="./home/images/linuxcn.png" width="230" height="80" alt="Linux中文社区"/>
            </a>
            <a href="http://zt.zhubajie.com/zt/makesite? utm_source=lagou.com&utm_medium=referral&utm_campaign=BD-yl"
               target="_blank" class="partnersAd">
                <img src="./home/images/zhubajie.jpg" width="230" height="80" alt="猪八戒"/>
            </a>
            <a href="http://www.imooc.com" target="_blank" class="partnersAd">
                <img src="./home/images/muke.jpg" width="230" height="80" alt="幕课网"/>
            </a>
        ...
        <div class="content">
            <div id="search_box">
                <form id="searchForm" name="searchForm" action="list.html" method="get">
                    ...
                    <input type="text" id="search_input" name="kd" tabindex="1" value="<?php echo $name ?>"
                ...
                <?php foreach ($data as $key => $value): ?>
                    ...
                    <li class="odd clearfix">
                        <div class="hot_pos_l">
                            <div class="mb10">
                                <a href="?r=index/jobdetail&position_id=<?php echo $value['position_id'] ?>"
                                   title="前端开发" target="_blank"><?php echo $value['position_name'] ?></a>
                                &nbsp;
                                <span class="c9">[<?php echo $value['workcity'] ?>]</span>
                            </div>
                            <span><em class="c7">月薪：</em><?php echo $value['salaryMin'] ?>
                                -<?php echo $value['salaryMax'] ?></span>
                        ...
                        <div class="hot_pos_r">
                            ...
                            <div class="mb10"><a href="h/c/1712.html" title="紫色医疗"
                                                 target="_blank"><?php echo $value['companyallname'] ?></a></div>
                            <span><em class="c7">领域： </em><?php echo $value['companyfield'] ?></span>
                            <span><em class="c7">创始人：</em> Lu</span>
                            <br/>
                            <span><em class="c7">阶段： </em><?php echo $value['companydevelopment'] ?></span>
                            <span><em class="c7">规模： </em><?php echo $value['companysize'] ?></span>
