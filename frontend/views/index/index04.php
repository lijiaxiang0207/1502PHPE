...
<div id="body">
    ...
    <div id="container">
        <!-- <script src="./home/js/swfobject_modified.js" type="text/javascript"></script> -->
        <div class="clearfix">
                ...
                <div class="c_detail">
                    <div style="background-color:#fff;" class="c_logo">
                        <a title="上传公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader">
                            <img width="190" height="190" alt="公司logo" src="./home/images/logo_default.png">
                    ...
                    <!--  			                <div class="c_logo" style="background-color:#fff;">
                            <div id="logoShow">
                                <img src="./home/images/logo_default.png" width="190" height="190" alt="公司logo" />
                                <span>更换公司图片<br />190px*190px 小于5M</span>
                            </div>
                    ...
                    <div class="c_box companyName">
                        ...
                        <div class="clear oneword" style="display: block;"><img width="17" height="15"
                            ...
                            <span>公司名称公司名称公司名称</span> &nbsp;<img width="17" height="15" src="./home/images/quote_r.png">
                        </div>
                ...
                <div id="Product">
                    ...
                    <div class="product_wrap">
                                ...
                                <form method="post" class="productForm">
                                    <div class="new_product">
                                        ...
                                        <div class="product_upload productShow">
                                            <img width="380" height="220" src="./home/images/product_default.png">
                        ...
                        <dl class="c_product">
                            ...
                            <dd>
                                <img width="380" height="220" alt="发大发" src="./home/images/product_default.png">
                                <div class="cp_intro">
                            ...
                            <div class="member_wrap">
                                    ...
                                    <form class="memberForm">
                                        <div class="new_portrait">
                                            ...
                                            <div class="portraitShow">
                                                <img width="120" height="120" src="./home/images/leader_default.png">
                                                <span>更换头像</span>
                                            </div>
                                ...
                                <div class="member_info">
                                    ...
                                    <div class="m_portrait">
                                        <div></div>
                                        <img width="120" height="120" alt="孙泰英" src="./home/images/leader_default.png">
                                    </div>
                    ...
                    <object width="650" height="470"
                        ...
                        <div>
                            ...
                            <p><a href="http://www.adobe.com/go/getflashplayer"><img width="112" height="33"
                                                                                     src="./home/images/get_flash_player.gif"
        ...
        <script src="./home/js/company.min.js" type="text/javascript"></script>
        <script>
            var avatar = {};
