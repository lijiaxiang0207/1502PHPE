    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul id="navheader" class="reset">
                ...
                <li class="current"><a rel="nofollow" href="?r=index/jianli">我的简历</a></li>
            </ul>
            <dl class="collapsible_menu">
                <dt>
                    <span><?php $session = \Yii::$app->session;
                        echo $session['email'] ?>&nbsp;</span>
            ...
            <div class="content_l">
                <div class="fl" id="resume_name">
                    <div class="nameShow fl">
                        <h1 title="<?php $session = \Yii::$app->session;
                        echo $session['email'] ?>的简历">
                            <?php $session = \Yii::$app->session;
                            echo $session['email'] ?>的简历</h1>
                    ...
                    <form class="fl dn" id="resumeNameForm">
                        ...
                        <input type="submit" value="保存"> | <a target="_blank" href="?r=resume/preview">预览</a>
                    </form>
                </div><!--end #resume_name-->
