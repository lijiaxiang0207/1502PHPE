...
<head>
    ...
    <script type="text/javascript" src="./home/js/jquery-hbzx.js"></script>
    <!--[if lte IE 8]>
    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul id="navheader" class="reset">
                ...
                <li>
                    <a rel="nofollow" href="?r=index/jianli">我的简历</a>
                </li>
                <li><a rel="nofollow" href="?r=index/create">发布职位</a></li>
            </ul>
                    ...
                    <dd class="resume resume_web">
                        <div>
                            <span> 你已有可投递的在线简历：<a title="jason的简历" target="_blank"
                                                  href="jianli.html"><strong>jason的简历</strong></a></span><br>
                        ...
                        <div class="dropdown_menu">
                            <div class="drop_l">
                                <img width="131" height="131"
                                     src="./home/images/b533f6e729e74b418fcd6862bbde95dc_318969.jpg">
                                <span>[仅限本人使用]</span>
                            </div>
                            <div class="drop_r">
                    ...
                    <dt>
                        <a target="_blank" href="h/c/5004.html">
                            <img width="80" height="80" alt="广州百田信息科技有限公司"
                                 src="./home/images/ff8080814356e881014357741e5910f1.jpg" class="b2">
                            <div>
                                <h2 class="fl">
                                    广州百田
