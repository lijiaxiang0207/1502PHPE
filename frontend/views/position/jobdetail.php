...
<head>
    ...
    <script src="./home/js/jquery-hbzx.js" type="text/javascript"></script>
    <!--[if lte IE 8]>
    ...
    <div id="container">
        <div class="clearfix">
            <div class="content_l">
                <dl class="job_detail">
                    <dt>
                    <h1 title="<?php echo $res['position_name'] ?>">
                        <em></em>
                        <div><?php echo $res['companyallname'] . $res['department'] ?>招聘</div>
                    ...
                    <dd class="job_request">
                        ...
                        <span><?php echo $res['workcity'] ?></span>
                        <span><?php echo $res['workYear'] ?> </span>
                        <span> <?php echo $res['education'] ?></span>
                        <span><?php echo $res['jobNature'] ?></span><br/>
                        <?php echo $res['positionAdvantage'] ?>
                        <!--<div>发布时间：3天前发布</div>-->
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">职位描述</h3>
                        <p>岗位职责： <br/><?php echo $res['positionDetail'] ?></p>
                        <p>&nbsp;岗位要求： <br/><?php echo $res['position_demand'] ?></p>
                    </dd>
            ...
            <div class="content_r">
                <dl class="job_company">
                    <dt>
                        <a href="h/c/683.html" target="_blank">
                            <img class="b2" src="./home/images/ff80808140ac5ed90140b953972e0215.png" width="80"
                                 height="80" alt="<?php echo $res['companyallname']; ?>"/>
                            <div>
                                <h2 class="fl">
                                    <?php echo $res['companyallname']; ?>

                                    <img src="./home/images/valid.png" width="15" height="19" alt="拉勾认证企业"/>
                    ...
                    <dd>
                        <ul class="c_feature reset">
                            <li><span>领域</span> <?php echo $res['companyfield']; ?></li>
                        ...
                        <h4>工作地址</h4>
                        <div><?php echo $res['positionAddress']; ?></div>
                        <div id="smallmap"></div>
                ...
                <a href="h/subject/s_zhouyou.html?utm_source=BD__lagou&utm_medium=&utm_campaign=zhouyou" target="_blank"
                   class="eventAd">
                    <img src="./home/images/zhouyou.jpg" width="280" height="135"/>
                </a>
            </div>
        </div>
        ...
        <div id="loginToolBar">
            <div>
                <em></em>
                <img src="./home/images/footbar_logo.png" width="138" height="45"/>
        ...
        <div style="display:none;">
            ...
            <div id="uploadFile" class="popup">
                <table width="100%">
                    ...
                    <tr>
                        <td align="center"><img src="./home/images/loading.gif" width="55" height="16" id="loadingImg"
        ...
        <script type="text/javascript" src="./home/js/job_detail.js"></script>
