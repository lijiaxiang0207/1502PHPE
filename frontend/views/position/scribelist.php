...
</script><script type="text/javascript" async="" src="./home/js/conversion.js"></script><script src="./home/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
...
<script src="./home/js/ajaxCross.json" charset="UTF-8"></script></head>
<body>
<div id="body">
	<div id="header">
    		<div class="wrapper">
            ...
            <div class="content_l">
            	<h1>我的职位订阅</h1>
	                    ...
	                    <input type="hidden" id="em1" value="888888888@qq.com">
	            	                ...
	            	                <a href="?r=position/scribeadd"  class="btn_big"  id="subBtn">新建订阅</a>
...
<div style="display:none;">	
        	...
        	<form id="registerPopForm">
	            <table width="100%">
	                ...
	                <tr>
	                	...
	                	<td>
	                		<input type="password" placeholder="请输入注册密码" id="psw" name="password" style="background-image: url(./home/images/img/a6y3y0Wx5kbFHvGuXzkgf0xhKnPzA4UTyaTB8Ph8AvcHi3fnsrZ7Wore02YViqVOrRXXPhfqP8j6MYlawoAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
	...
	<div style="height:240px;" class="popup" id="loginPop">
       	<form id="loginForm">
			<input type="text" placeholder="请输入登录邮箱地址" tabindex="1" name="email" id="email" style="background-image: url(./home/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
			<input type="password" placeholder="请输入密码" tabindex="2" name="password" id="password" style="background-image: url(./home/images/img/0CQnd2Jos49xUAAAAASUVORK5CYII=quot); background-repeat: no-repeat; background-attachment: scroll; background-position: right center;">
...
<script src="./home/js/sub.min.js"></script>
<!-- 退订 | 从邮箱进来订阅页  -->
