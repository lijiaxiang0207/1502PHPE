...
<head>
    ...
    <script type="text/javascript" src="./home/js/analytics.js"></script>
...
<div class="login_wrapper">
    <div class="login_header">
        <a href="index.html"><img src="./home/images/logo_white.png" width="285" height="62" alt="拉勾招聘"/></a>
        <div id="cloud_s"><img src="./home/images/cloud_s.png" width="81" height="52" alt="cloud"/></div>
        <div id="cloud_m"><img src="./home/images/cloud_m.png" width="136" height="95" alt="cloud"/></div>
    </div>

    <input type="hidden" id="resubmitToken" value=""/>
    <div class="find_psw">
        <h3 align="center"><b>重置密码</b></h3>
        <form id="pswForm" action="index.php?r=login/resetpwd" method="post">

            <input type="password" name="password" id="password" tabindex="1" value="" placeholder="请输入新密码"/>
            <input type="password" name="repassword" id="repassword" tabindex="1" value="" placeholder="请再次输入新密码"/>
            <input type="submit" id="submitLogin" value="确定"/>
        </form>
        <!--<img src="./home/images/psw_step1.png" width="369" height="56" alt="找回密码第二步" />
        <form id="pswForm" action="index.php?r=flogin/reset" method="post">
