...
<div class="login_wrapper">
    <div class="login_header">
        <a href="?r=index/index"><img src="./home/images/logo_white.png" width="285" height="62" alt="拉勾招聘"/></a>
    ...
    <div class="login_box">
        <form id="loginForm" method="post" action="index.php?r=login/login">
            ...
            <a href="?r=login/res" class="fr" target="_blank">忘记密码？</a>

            <input type="submit" id="submitLogin" value="登 &nbsp; &nbsp; 录"/>
            <!-- <a style="color:#fff;" href="index.html" class="submitLogin" title="登 &nbsp; &nbsp; 录"/>登 &nbsp; &nbsp; 录</a> -->
            <!-- <input type="submit" class="submitLogin" title="登 &nbsp; &nbsp; 录" value="登 &nbsp; &nbsp; 录" /> -->
