...
<div id="body">
    <div id="header">
        <div class="wrapper">
            ...
            <ul id="navheader" class="reset">
                ...
                <li class="current"><a rel="nofollow" href="?r=resume/resume">我的简历</a></li>
            </ul>
    ...
    <div id="container">
        ...
        <div class="clearfix">
            <div class="content_l">
                <div class="fl" id="resume_name">
                    <div class="nameShow fl">
                        ...
                        <a target="_blank" href="?r=preview/preview">预览</a>
                    </div>
                    <!-- <form class="fl dn" id="resumeNameForm">
                        <input type="text" value="jason的简历" name="resumeName" class="nameEdit c9">
                        <input type="submit" value="保存"> | <a target="_blank" href="?r=preview/preview">预览</a>
                    </form> -->
                </div><!--end #resume_name-->
                ...
                if (empty($data)) {
                    ...
                    echo $data['re_lasttime'];
                }
                ?>
            		
            	</span></div><!--end #lastChangedTime-->
                ...
                <div class="profile_box" id="basicInfo">
                    ...
                    <div class="basicShow">
                        ...
                        <?php } else { ?>
	            			...
	            			<?php echo $data['re_name'] ?> |
                                ...
                                <?php echo $data['re_topdegree'] ?> |
                                <?php echo $data['re_workyear'] ?><br>
                                <?php echo $data['re_tel'] ?> |
                                <?php echo $data['re_email'] ?><br>
	            			</span>
                        <?php } ?>
                        <div class="m_portrait">
                            <div></div>
                            <img width="120" height="120" alt="jason" src="./home/images/default_headpic.png">
                        </div>
                    </div><!--end .basicShow-->
                        ...
                        <form id="profileForm">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" placeholder="学历" id="topDegree" value="学历"
                                               name="topDegree">
                                        <input type="button" value="学历" id="select_topDegree"
                                    ...
                                    <td>
                                        <input type="hidden" placeholder="工作年限" id="workyear" name="workyear">
                                        <input type="button" placeholder="工作年限" id="select_workyear"
                                               class="profile_select_190 profile_select_normal">
                    ...
                    <input type="hidden" id="topDegreeVal"
                           value="<?php if (!empty($data)) {
                               echo $data['re_topdegree'];
                           } ?>">
                    <input type="hidden" id="workyearVal"
                           value="<?php if (!empty($data)) {
                               echo $data['re_workyear'];
                           } ?>">
                    <input type="hidden" id="currentStateVal"
                           value="<?php if (!empty($data)) {
                               echo $data['re_currentState'];
                           } ?>">
            ...
            <div class="content_r">
                ...
                <div class="greybg qrcode mt20">
                    <img width="242" height="242" alt="拉勾微信公众号二维码" src="./home/images/qr_resume.png">
        ...
        <script src="./home/js/Chart.min.js" type="text/javascript"></script>
        <script src="./home/js/profile.min.js" type="text/javascript"></script>
