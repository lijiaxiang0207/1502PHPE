    ...
    <div id="header">
        <div class="wrapper">
            ...
            <ul class="reset" id="navheader">
                ...
                <li class="current"><a href="?r=create/refuse" rel="nofollow">不合适简历</a></li>
            </ul>
                                ...
                                <div class="resumeShow">
                                    <a title="预览在线简历" target="_blank" class="resumeImg"
                                       href="resumeView.html?deliverId=1686182">
                                        <img src="./home/images/default_headpic.png">
                                    </a>
...
再次感谢您对我们的信任，祝您早日找到满意的工作。</textarea>
        ...
        <!------------------------------------- end ----------------------------------------->
        <script src="./home/js/jquery.ui.datetimepicker.min.js" type="text/javascript"></script>
        <script src="./home/js/received_resumes.min.js" type="text/javascript"></script>
        <script>
        </script>
        <div class="clear"></div>
