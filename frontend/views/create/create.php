...
<head>
    ...
    <link href="./home/css/external.min.css" type="text/css" rel="stylesheet">
    <link href="./home/css/popup.css" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="./home/js/jquery.1.10.1.min.js"></script>
    <script src="./home/js/jquery.lib.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="./home/js/ajaxfileupload.js"></script>
    <script src="./home/js/additional-methods.js" type="text/javascript"></script>
    <!--[if lte IE 8]>
    ...
    <script src="./home/js/conv.js" type="text/javascript"></script>
    <script src="./home/js/ajaxCross.json" charset="UTF-8"></script>
    <style type="text/css">.BMap_mask {
            background: transparent url(./home/images/img/blank.gif);
        }
        ...
        .BMap_zoomer {
            background-image: url(./home/images/img/mapctrls1d3.gif);
        ...
        .BMap_stdMpPan {
            ...
            height: 44px;
            overflow: hidden;
            background: url(./home/images/img/mapctrls2d0.png) no-repeat;
        }
        ...
        .BMap_ie6 .BMap_smcbg {
            ...
            width: 44px;
            height: 464px;
            filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="./home/images/img/mapctrls2d0.png");
        }
        ...
        .BMap_stdMpZoom .BMap_button {
            ...
            left: 12px;
            overflow: hidden;
            background-image: url(./home/images/img/mapctrls2d0.png);
            background-repeat: no-repeat;
            z-index: 10;
        }
        ...
        .BMap_stdMpType4 .BMap_smcbg {
            position: static;
            background: url(./home/images/img/mapctrls2d0_mb.png) 0 0 no-repeat;
        ...
        .BMap_stdMpSliderBgTop {
            ...
            width: 10px;
            overflow: hidden;
            background: url(./home/images/img/mapctrls2d0.png) no-repeat -23px -226px;
        }
        ...
        .BMap_stdMpSliderBgBot {
            ...
            top: 124px;
            overflow: hidden;
            background: url(./home/images/img/mapctrls2d0.png) no-repeat -33px bottom;
        }
        ...
        .BMap_stdMpSliderBar {
            ...
            top: 80px;
            overflow: hidden;
            background: url(./home/images/img/mapctrls2d0.png) no-repeat 0 -309px;
        }

        .BMap_stdMpSliderBar.h {
            background: url(./home/images/img/mapctrls2d0.png) no-repeat 0 -320px;
        }
        ...
        .BMap_omBtn {
            ...
            cursor: pointer;
            overflow: hidden;
            background: url(./home/images/img/mapctrls1d3.gif) no-repeat;
            z-index: 1210;
        }
        ...
        .BMap_checkbox {
            background: url(./home/images/img/mapctrls1d3.gif);
        ...
        .BMap_vectex_nodeT {
            background-image: url(./home/images/img/nodeT.gif);
        }

        .BMap_vectex_node {
            background-image: url(./home/images/img/node.gif);
        }
        ...
        .iw_search, .iw_l {
            background: url("./home/images/img/u20LgruGtNFM8lqnNtfK2JqN3CVeW1gzWj9jThd0xd59R8BBgAAiefGO1Bt1gAAAABJRU5ErkJggg==") no-repeat 50% 50%;
            -webkit-background-size: 19px 19px;
        }

        .iw_line_s, .iw_r {
            background: url("./home/images/img/wCKLRHq20vjSoVNKWunH4rTBDv5Cv7NKeKfvvU2nINzHAuexzUA7KQTkoB6UxDicKvcqfQQYABaiUBxugCsr20AAAAAElFTkSuQmCC") no-repeat 50% 50%;
            -webkit-background-size: 19px 19px;
        }
        ...
        .route_tip_con .route_tip span {
            ...
            width: 14px;
            height: 13px;
            background: url(./home/images/img/addrPage.png) no-repeat 0 -121px;
            cursor: pointer;
        }
        ...
        .sel_n .sel_top {
            background: url(./home/images/img/bgs.gif) no-repeat 0 -418px;
            height: 4px;
            font-size: 0px;
        }
        ...
        .sel_n .sel_body_top {
            height: 32px;
            width: 100%;
            background: url(./home/images/img/addrPage.png) no-repeat 0 -41px;
        }
        ...
        .sel_n .sel_body_sign {
            ...
            height: 31px;
            float: left;
            background: url(./home/images/img/bgs.gif) no-repeat -79px -387px;
        }
        ...
        .sel_n .sel_bottom {
            background: url(./home/images/img/bgs.gif) no-repeat 0 -415px;
            height: 4px;
            font-size: 0px;
        }
        ...
        .sel_n1 .sel_body_top {
            height: 31px;
            width: 100%;
            background: url(./home/images/img/sel_body_n_top.gif) repeat-x;
        }
        ...
        .sel_n1 .sel_body_button {
            ...
            height: 31px;
            margin-left: -23px;
            background: url(./home/images/img/bgs.gif) no-repeat -253px -382px;
            overflow: hidden;
            zoom: 1;
            cursor: pointer;
        }
        ...
        .sel_y .sel_top {
            background: url(./home/images/img/bgs.gif) no-repeat 0 -439px;
            height: 4px;
            zoom: 1;
            font-size: 0px;
        }
        ...
        .sel_y .sel_body_top {
            height: 32px;
            width: 100%;
            background: url(./home/images/img/addrPage.png) no-repeat 0 0
        }
        ...
        .sel_y .sel_body_sign {
            ...
            height: 31px;
            float: left;
            background: url(./home/images/img/bgs.gif) no-repeat -167px -384px;
        }
        ...
        .sel_y .sel_body_button {
            ...
            height: 31px;
            margin-left: -20px;
            background: url(./home/images/img/bgs.gif) no-repeat -269px -297px;
            cursor: pointer;
        }
        ...
        .sel_y .sel_bottom {
            background: url(./home/images/img/bgs.gif) no-repeat 0 -436px;
            height: 4px;
            font-size: 0px;
        }
        ...
        .sel_x .sel_body_sign {
            ...
            height: 31px;
            float: left;
            background: url(./home/images/img/bgs.gif) no-repeat -122px -384px;
        }
        ...
        .sel_body_resitem th div.iconbg {
            background: url(./home/images/img/markers_new_ie6.png) no-repeat scroll 0 0;
            height: 29px;
            width: 24px;
        }
        ...
        .sel_body_resitem td .selBtn {
            width: 70px;
            height: 29px;
            background: url(./home/images/img/addrPage.png) no-repeat -21px -81px;
            text-align: center;
            line-height: 29px;
            visibility: hidden;
            color: #b35900;
    ...
    <link rel="stylesheet" href="./home/css/ui.css">
    <link rel="stylesheet" href="./home/css/window.css">
</head>
<body>
<div id="body">
    <div id="header">
    ...
    <div id="container">
        ...
        <div class="sidebar">
            <a class="btn_create" href="?r=create/index">发布新职位</a>
            <dl class="company_center_aside">
                ...
                <dd>
                    <a href="?r=create/interview">待定简历</a>
                </dd>
                <dd>
                    <a href="haveNoticeResumes.html">已通知面试简历</a>
                </dd>
                <dd>
                    <a href="?r=create/refuse">不合适简历</a>
                </dd>
                <dd class="btm">
                    <a href="?r=create/filter">自动过滤简历</a>
                </dd>
            </dl>
            <dl class="company_center_aside">
                <dt>我发布的职位</dt>
            ...
            <dl class="company_center_content">
                ...
                <dd>
                    ...
                    <form action="?r=create/add" method="post">
                        ...
                        <input type="hidden" value="create" name="">
                        <input type="hidden" value="25927" name="">
                        <input type="hidden" value="c29d4a7c35314180bf3be5eb3f00048f" name="">
                        <table class="btm">
                            <tbody>
                            <tr>
                                ...
                                <td width="85">职位类别</td>
                                <td>
                                    <input type="hidden" id="positionType" value="" name="pcate_id">
                                    ...
                                    <div class="dn" id="box_job" style="display: none;">
                                        <dl>
                                            <?php foreach ($arr as $key => $val) { ?>
                                                <dt><?php echo $val['pcate_name'] ?></dt>
                                                <dd>
                                                    <ul class="reset job_main">
                                                        <?php foreach ($val['child'] as $ke => $va) { ?>
                                                            <li>
                                                                <span
                                                                    id="positionName1" <?php echo $va['pcate_id'] ?>><?php echo $va['pcate_name'] ?></span>
                                                                <ul class="reset job_sub dn">
                                                                    <?php foreach ($va['child'] as $k => $v) { ?>
                                                                        <li id="positionName2"
                                                                            uu="<?php echo $v['pcate_id'] ?>"><?php echo $v['pcate_name'] ?></li>
                                                                    <?php } ?>
                                                                </ul>
                                                            </li>
                                                        <?php } ?>
                            ...
                            <tr>
                                ...
                                <td>职位名称</td>
                                <td>
                                    <input type="text" placeholder="请输入职位名称，如：产品经理" value="" name="position_name"
                                           id="positionName">
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td>工作城市</td>
                                <td>
                                    <input type="text" placeholder="请输入工作城市，如：北京" value="上海" name="workcity"
                                           id="workAddress">
                                </td>
                            </tr>
                            </tbody>
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <textarea name="positionDetail" id="" cols="30" rows="10"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td><span class="redstar">*</span></td>
                        ...
                        <table>
                            ...
                            <tr>
                                <td width="25"><span class="redstar">*</span></td>
                                <td colspan="2">
                                    接收简历邮箱： <span id="receiveEmailVal"></span>
        ...
        <div style="display:none;">
            ...
            <div class="popup" id="baiduMap">
                ...
                <div id="allmap"
                    ...
                    <div
                        style="position: absolute; z-index: 1201; top: 10px; right: 10px; width: 17px; height: 16px; background: url(./home/images/img/st-close.pngquot) no-repeat scroll 0% 0% transparent; cursor: pointer; display: none;"
                        title="退出全景"></div>
                    <div
                        ...
                        class=" anchorBL"><a title="到百度地图查看此区域" target="_blank" href="http://map.baidu.com/?sr=1"
                                             style="outline: medium none;"><img src="./home/images/copyright_logo.png"
                    ...
                    <div unselectable="on" class=" BMap_scaleCtrl BMap_noprint anchorBL"
                        ...
                        <div class="BMap_scaleBar BMap_scaleHBar" style="background-color: black;"><img
                                src="./home/images/mapctrls.png" style="border:none"></div>
                    ...
                    <div unselectable="on" class=" BMap_cpyCtrl BMap_noprint anchorBL"
                        ...
                        <span _cid="1" style="display: inline;"><span style="font-size:11px">&copy; 2014 Baidu&nbsp;- Data &copy;
                                <a style="display:inline;" href="http://www.navinfo.com/" target="_blank">NavInfo</a> &amp; <a
                                    style="display:inline;" href="http://www.cennavi.com.cn/"
                                    target="_blank">CenNavi</a> &amp; <a style="display:inline;"
                                                                         href="http://www.365ditu.com/" target="_blank">道道通</a></span></span>
                    </div>
                </div>
            </div><!--/#baiduMap-->
        </div>
        <!------------------------------------- end ----------------------------------------->
        <!-- <script type="text/javascript" src="./home/js/tinymce.min.js"></script>
<script>
$(function(){
	...
	tinymce.init({
        ...
        <!-- old -->
        <script src="./home/js/jquery.tinymce.js" type="text/javascript"></script>
        <script>
            $(function () {
        ...
        <script src="./home/js/jobs.min.js" type="text/javascript"></script>
...
<script src="./home/js/core.min.js" type="text/javascript"></script>
<script src="./home/js/popup.min.js" type="text/javascript"></script>
